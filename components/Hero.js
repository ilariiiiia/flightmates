      ...
      <div className="grid gap-3">
        ...
        <form>
          ...
          <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
            ...
            <button
              type="submit"
              className="text-amber-200 absolute right-2.5 bottom-2.5 bg-amber-700 hover:bg-amber-800 focus:ring-2 focus:outline-none focus:ring-amber-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Search
            </button>
          </div>
